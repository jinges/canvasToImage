(function (global, factory) {
  ...
  (function (global, factory) {
    ...
    var DrawTable = function () {
      function DrawTable(title, reviceObject, titles, scoreList, baseColor, ratios) {
      ...
      _createClass(DrawTable, [{
            ...
            score.forEach(function (item, key) {
              ...
              if (!item.isSubmit) {
                ...
                if (!item.trueCount && !item.falseCount) {
                  ...
                  text = ' ' + item.trueCount + '\u221A | ' + item.falseCount + '\xD7 ';
                  ctx.fillText(text, _this.pixelRatio(100 * (key + 2) + 50), _this.pixelRatio(top + 46), _this.pixelRatio(100));
        ...
        value: function watermark() {
          var canvas = this.canvas;
          var ctx = this.ctx;
          var width = this.canvas.width + 400;
          var height = this.canvas.height + 200;
